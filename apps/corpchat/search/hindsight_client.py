"""
CorpChat Search — Hindsight Memory Bridge
==========================================
REST client for the Hindsight memory layer (API :8888).

Gives CorpChat a cross-session memory backend:
  - retain: store messages/conversations into a memory bank
