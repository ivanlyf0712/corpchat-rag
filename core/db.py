...
def get_db_connection():
    ...
    Fail-fast when DB_PASSWORD is missing (P0 security fix, candidate 5):
    the credential must come from the environment, never from a committed
    default. Compose passes DB_PASSWORD; local runs must set it in .env.
    """
...
# ── CorpChat persistence (candidate 5: moved to core/corpchat_db.py) ──
